...
\paragraph{Overview.}
By phrasing \emph{behavioral equivalences as energy games}, we obtain a uniform way to decide a wide range of equivalences in van Glabbeek's \emph{linear-time--branching-time spectrum} for systems with \emph{silent steps}~\cite{glabbeek1990ltbt1,glabbeek1993ltbt2}.
...
Some of the proofs in this document are due to pen-and-paper proofs by David N. Jansen.
