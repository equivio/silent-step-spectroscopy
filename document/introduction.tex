...
Therefore, Bisping and Jansen \cite{bj2023silentStepSpectroscopyArxiv} included a measure of expressiveness for HML$_\text{{SRBB}}$ formulas as eight-dimensional vectors.
...
It is therefore possible to decide for a whole spectrum of behavioural equivalences at the same time which of them apply \cite{bj2023silentStepSpectroscopyArxiv}.
\\\\
We formalize the eight-dimensional weak spectroscopy game, 
which ``can be used to decide a wide array of behavi[ou]ral equivalences between stability-respecting branching bisimilarity and weak trace equivalence in one go''\cite[Abstract]{bj2023silentStepSpectroscopyArxiv}.
We then outline the proof of the correspondence between ``attacker-winning energy budgets and distinguishing sublanguages of Hennessy-Milner [L]ogic characterized by eight dimensions of formula expressiveness''\cite[Abstract]{bj2023silentStepSpectroscopyArxiv}.
With our formalization we try to follow \cite{bj2023silentStepSpectroscopyArxiv} as closely as possible in how we formalize the weak spectroscopy game, HML and their correspondence.
...
Following these fundamentals, we state our formalization of the theorem $1$ of \cite{bj2023silentStepSpectroscopyArxiv}, that ``relate[s] attacker-winning energy budgets and distinguishing sublanguages of Hennessy-Milner [L]ogic''\cite[Abstract]{bj2023silentStepSpectroscopyArxiv}. 
Based on the proof in \cite{bj2023silentStepSpectroscopyArxiv} we outline a proof for this theorem through three lemmas. 
...
Finally, we discuss the minor issues we found in the paper and thus present our contributions to \cite{bj2023silentStepSpectroscopyArxiv} and end this report with a conclusion.