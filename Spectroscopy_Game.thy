...
text\<open>Next we show that the lemma win_a_upwards_closure, which shows that with more energy the 
...
and  \<open>e \<le> Upd(e)\<close> holds for all energies and updates. \<close> 
